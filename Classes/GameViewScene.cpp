...
bool GameViewScene::init()
{
    ...
    targetLabelText = Label::createWithTTF("Target:", "fonts/MarkerFelt.ttf", 14);
    movesLabelText = Label::createWithTTF("Moves:", "fonts/MarkerFelt.ttf", 14);
    scoreLabelText = Label::createWithTTF("Score:", "fonts/MarkerFelt.ttf", 14);
    targetLabel = Label::createWithTTF("999999", "fonts/MarkerFelt.ttf", 20);
    movesLabel = Label::createWithTTF("999999", "fonts/MarkerFelt.ttf", 20);
    scoreLabel = Label::createWithTTF("999999", "fonts/MarkerFelt.ttf", 20);
    ...
    for (int i = 0; i <= Level::NumRows; i++) {
        for (int j = 0; j <= Level::NumColumns; j++) {
            ...
            if (value != 0 && value != 6 && value != 9) {
                std::string fileName = "Grid/Tile_" + StringUtils::toString(value) + ".png";
...
void GameViewScene::animateScoreForCookies(Chain* chain) {
    ...
    Cookie* lastCookie = chain->cookies[chain->cookies.size() - 1];
        ...
        cocos2d::Label* label = cocos2d::Label::createWithTTF( StringUtils::toString(chain->score), "fonts/MarkerFelt.ttf", 20);
...
void GameViewScene::updateLabels() {
    targetLabel->setString(StringUtils::toString((long)level->targetScore));
    movesLabel->setString(StringUtils::toString((long)movesLeft));
    scoreLabel->setString(StringUtils::toString((long)score));
}
